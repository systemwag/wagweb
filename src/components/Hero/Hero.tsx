...
export default function Hero({ registryTotal, years }: HeroProps) {
  return (
    <section className={`${styles.hero} filmgrain`}>
      ...
      {/* Частицы приглушены: единственный фокус хиро — золотой знак по центру */}
      <InteractiveCanvasBg particleCount={90} opacity={0.7} />
      <HeroEngineeringAnim />
      {/* Radial glow orbs */}
      ...
      <div className={`${styles.heroLogo} no-select`} aria-hidden="true">
        ...
        >
          <defs>
            {/* Specular sweep: короткий блик пробегает по знаку раз в цикл
                вращения (7s), в паузах градиент уведён за пределы фигуры */}
            <linearGradient id="wagSheen" gradientUnits="objectBoundingBox" x1="0" y1="0" x2="1" y2="0.35">
              <stop offset="0.38" stopColor="#FFF4D6" stopOpacity="0" />
              <stop offset="0.5" stopColor="#FFF4D6" stopOpacity="0.55" />
              <stop offset="0.62" stopColor="#FFF4D6" stopOpacity="0" />
              <animateTransform
                attributeName="gradientTransform"
                type="translate"
                values="-1.4 0; -1.4 0; 1.4 0; 1.4 0"
