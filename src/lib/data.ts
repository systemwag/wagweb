...
const SEED_DESIGN_PROJECTS: DesignProject[] = [
  {
    ...
    slug: 'design-1', description: 'Полный цикл проектирования двух железнодорожных путей для отстоя вагонов с изысканиями, ПСД и экспертизой.', images: [], featured: true, created_at: '',
  },
  {
    ...
    slug: 'design-2', description: 'Рабочий проект ж.д. подъездного пути с полным циклом изысканий и прохождением государственной экспертизы.', images: [], featured: true, created_at: '',
  },
  {
    ...
    slug: 'design-3', description: 'Проектирование железнодорожных путей для крупнейшего в СНГ комплекса по производству ж.д. колёс.', images: [], featured: true, created_at: '',
  },
  {
    ...
    slug: 'design-4', description: 'Технико-экономическое обоснование развития путевого хозяйства для крупного металлургического предприятия.', images: [], featured: true, created_at: '',
  },
  {
    ...
    category: 'full-cycle', location: null, year: null, status: 'completed',
    slug: 'design-5', description: 'Рабочий проект ж.д. подъездного пути с полным пакетом ПСД и экспертным сопровождением.', images: [], featured: false, created_at: '',
  },
];
