...
/* Floating screen-only print controls for the design brochure. Mirrors
   ../PrintButtons.tsx (reuses the same print.module.css classes); kept
   local so the route is self-contained. Hidden under @media print. */
