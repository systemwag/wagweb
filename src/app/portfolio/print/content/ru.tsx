...
const RU_CONTENT: PrintContent = {
  cover: {
    ...
    badges: [
      ...
      { level: '1 класс', area: 'Экологическое проектирование: ОВОС и СЗЗ' },
    ],
    tagline: [
  ...
  about: {
    ...
    industryChips: [
      'Ж/д и автодороги',
      'Трубопроводы',
      'ЛЭП и слаботочные системы',
      'Промышленные объекты',
      <>Инженерные сети<span className={styles.industryCardSub}>газоснабжение · водоснабжение · водоотведение · электроснабжение · теплоснабжение</span></>,
    ],
  ...
  scale: {
    ...
    people: [
      ...
      { num: '15+', label: 'Проектный отдел',      desc: 'Инженеры-проектировщики, ГИП, сметчики' },
      { num: '10+', label: 'Изыскательский отдел', desc: 'Геодезисты, геологи' },
      { num: '50+', label: 'Строительные бригады', desc: 'Прорабы, инженеры СЦБ, инженеры-путейцы, дорожные мастера, мастера общестроительных работ' },
    ],
  },
  ...
  licenses: [
    {
      ...
      meta: [
        { label: 'ОРГАН ВЫДАЧИ', value: 'Управление ГАСК Актюбинской области' },
    ...
    },
    {
      ...
      meta: [
        ...
        { label: 'ОБЪЁМ', value: 'Раздел ОВОС в составе ПСД и СЗЗ (санитарно-защитная зона)' },
      ],
    },
  ],
  ...
  dirDesign: {
    ...
    svcs: [
      ...
      { num: '04', title: 'Транспортная инфраструктура',       desc: 'Проектирование объектов транспорта, связи и коммуникаций, включая авто- и железнодорожную инфраструктуру.' },
      { num: '05', title: 'Инженерные системы и сети',         desc: 'Проектная документация для инженерных систем: электро-, водо-, теплоснабжение, водоотведение и слаботочные сети.' },
    ...
    process: [
      ...
      { roman: 'II', title: 'ПСД и РД',       meta: 'Проектно-сметная и рабочая документация' },
      { roman: 'III',title: 'ГосЭкспертиза', meta: 'Согласование РГП' },
      { roman: 'IV', title: 'Авторский надзор', meta: 'Сопровождение СМР · технадзор' },
    ],
  ...
  dirBuild: {
    ...
    process: [
      ...
      { roman: 'II', title: 'Земляные работы',  meta: 'Выемка · насыпь · подготовка основания' },
      { roman: 'III',title: 'Верхнее строение', meta: 'РШР · покрытия и дорожная одежда · монтаж' },
  ...
  contacts: {
    ...
    team: [
      { num: '01', role: 'Генеральный директор',     name: 'Аронов Аян Садиржанович' },
