...
export const metadata: Metadata = {
  title: 'Обслуживание и текущий ремонт | West Arlan Group',
  description:
    'Текущее содержание, текущий и капитальный ремонт, осмотр и дефектация, реконструкция инженерной инфраструктуры. Долгосрочные контракты обслуживания.',
};
